...
data_dir = '/nfs-nvme/home/share/checkpoints_profiles/spec06_rv64gcb_o2_20m/take_cpt' # cpt dir
...
if args.name is not None:
    task_name = f'gem5_{ver}/' + args.name
else:
    task_name = f'gem5_{ver}/{CurConf.__name__}-{tag}'
